...
<head>
    ...
    <title>Danh sách Exercise - Admin Dashboard</title>
            ...
            <c:choose>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="${pageContext.request.contextPath}/admin/exercise/edit?id=${exercise.id}" class="btn btn-edit">
                ...
                <c:otherwise>
                    <div class="empty-state">
                        ...
                        <p>Chưa có bài tập nào trong hệ thống. Hãy thêm bài tập đầu tiên!</p>
                        <a href="${pageContext.request.contextPath}/admin/exercise/add" class="btn btn-primary">
                            <i class="fas fa-plus"></i>
